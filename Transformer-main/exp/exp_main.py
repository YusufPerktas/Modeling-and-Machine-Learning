...
class Exp_Main(Exp_Basic):
    ...
    def train(self, setting):
        ...
        train_losses_epoch = []  # Eğitim kayıplarını saklamak için
        vali_losses_epoch = []   # Doğrulama kayıplarını saklamak için
        test_losses_epoch = []    
        for epoch in range(self.args.train_epochs):
            ...
            vali_losses_epoch.append(vali_loss)
        ...
        self.model.load_state_dict(torch.load(best_model_path))
         # Eğitim ve doğrulama kayıpları için grafik oluşturma
        plot_loss(train_losses_epoch, vali_losses_epoch, test_losses_epoch, setting)
        return
